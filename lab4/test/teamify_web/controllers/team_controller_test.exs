defmodule TeamifyWeb.TeamControllerTest do
  ...
  @create_attrs %{
    team_leader_id: "7488a646-e31f-11e4-aace-600308960662"
  }
  @update_attrs %{
    team_leader_id: "7488a646-e31f-11e4-aace-600308960668"
  }
  ...
  describe "update team" do
    ...
    test "renders team when data is valid", %{conn: conn, team: %Team{project_id: id} = team} do
